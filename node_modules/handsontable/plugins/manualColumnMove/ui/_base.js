...
class BaseUI {
  ...
  setOffset(top, inlineOffset) {
    ...
    if ((0, _number.isNumeric)(inlineOffset)) {
      this._element.style[`margin${(0, _string.toUpperCaseFirst)(this.inlineProperty)}`] = inlineOffset + UNIT;
    }
  }
  ...
  getOffset() {
    const style = this._element.style;
    const inlineProp = `margin${(0, _string.toUpperCaseFirst)(this.inlineProperty)}`;
    return {
