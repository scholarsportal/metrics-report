...
class DataManager {
  ...
  rewriteCache() {
    ...
    (0, _number.rangeEach)(0, this.data.length - 1, i => {
  ...
  cacheNode(node, level, parent) {
    ...
    if (this.hasChildren(node)) {
      (0, _array.arrayEach)(node.__children, elem => {
  ...
  readTreeNodes(parent, readCount, neededIndex, neededObject) {
    ...
    if (parentObj.__children) {
      (0, _array.arrayEach)(parentObj.__children, val => {
  ...
  mockNode() {
    const fakeNode = {};
    (0, _object.objectEach)(this.data[0], (val, key) => {
      fakeNode[key] = null;
    });
    return fakeNode;
  }
  ...
  countChildren(parent) {
    ...
    (0, _array.arrayEach)(parentNode.__children, elem => {
      rowCount += 1;
      if (elem.__children) {
  ...
  filterData(index, amount, logicRows) {
    ...
    (0, _array.arrayEach)(logicRows, elem => {
      elementsToRemove.push(this.getDataObject(elem));
    });
    (0, _array.arrayEach)(elementsToRemove, elem => {
